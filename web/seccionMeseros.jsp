                ...
                <nav class="row navbar navbar-light">
                    <form action="ListarClientes" class="form-inline" method="post"> 
                        <input class="form-control mr-sm-2" type="search" placeholder="Buscar..." 
                               aria-label="Search" id="searchInput" name="search" value="<% if (request.getParameter("search") != null) {
                    ...
                    <table class="table table-responsive" >
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <%
                                        puntuacion = (int) mesero.getPuntuacionTotal();
                                        tieneDecimal = false;
                                        for (int i = 0; i < puntuacion; i++) {
                                    %>
                                    <img src="css/imagenes/star.png" height="17px" style="display: inline">
                                    <%
                                        }
                                    %>
                                    <%
                                        if (mesero.getPuntuacionTotal() % 1 != 0) {
                                            tieneDecimal = true;
                                    %>
                                    <img src="css/imagenes/star-mitad.png" height="17px" style="display: inline">
                                    <%
                                        }
                                    %>
                                    <%
                                        double estrellasGrises = 0;
                                        if (tieneDecimal) {
                                    ...
                                    %>
                                    <img src="css/imagenes/star-gris.png" height="17px" style="display: inline">
                                    <%
                                        }
                                    %>
